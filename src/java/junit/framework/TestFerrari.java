...
public class TestFerrari {
	...
	public static List<TestThreadSafety> testParallel(TestCase testCase) throws Exception {
		return testParallel(testCase, 3);
	}	
	
	public static List<TestThreadSafety> testParallel(TestCase testCase, int threads) throws Exception {
		List<TestThreadSafety> tests = TestThreadSafety.runInParallel(testCase, threads);
