...
public class DataRandomPrimitives {
	...
	public static List<String> getString(int total) {
		return pickRandomFromFile(total, "dictionary.txt", 10000);
	}
	...
	public static List<String> getUnicodeString(int total) {
		return pickRandomFromFile(total, "i18n.txt", 20);
	}
	
	private static List<String> pickRandomFromFile(int total, String aFile, int maxSize) {
		
		BufferedReader reader = null;
		InputStream stream = null;
		try {
			stream =ClassLoader.getSystemClassLoader().getResourceAsStream(aFile);
